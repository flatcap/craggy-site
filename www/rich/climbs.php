...
function climbs_main($options)
{
	...
	switch ($options['format']) {
		case 'html':
			...
			$output .= "<div id='title'>";
			$output .= "<h1>Climbs</h1> <span>(Last updated: $last_update)</span></div>\n";
			$output .= '</div>';

			$output .= "<div id='download'>";
			$output .= '<h3>Route Data</h3>';
			$output .= "<a href='?format=text'><img alt='climb list as a formatted text document' width='32' height='32' src='../img/txt.png'></a>";
			$output .= "<a href='?format=csv'><img alt='climb list as a csv document' width='32' height='32' src='../img/ss.png'></a>";
			$output .= '</div>';
