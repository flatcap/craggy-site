...
echo
echo "truncate climb;"
echo "truncate climber;"
echo "truncate route;"
echo "truncate setter;"
echo

# 10 random girl setters
echo "insert into setter (initials, first_name, surname) values "
...
echo "insert into climber (first_name, surname) values"
...
#  10 setters
# 200 max days old
echo "insert into route (panel_id, colour_id, grade_id, setter_id, date_set) values"
for ((i = 0; i < 200; i++)); do
	PANEL=$((RANDOM%86+1))
	COLOUR=$((RANDOM%21+1))
	GRADE=$((RANDOM%20+1))
...
# 4 success_id
echo "insert into climb (climber_id, route_id, success_id, date_climbed) values"
for ((i = 0; i < 5000; i++)); do
